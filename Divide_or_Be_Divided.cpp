/*┌────────────────────────────────────────────────────────────────────────────────────┐
  ...
  │                        >   Author:- Nazrul Islam                   
  │Problem Link: https://www.hackerrank.com/contests/ycpc-beginners-round-2k25/challenges/the-second-round-1
  └────────────────────────────────────────────────────────────────────────────────────┘*/
#include <bits/stdc++.h>
using namespace std;
...
void run_case(){
    ...
    int y = s[b-1]-'0';
    if(x==0&&y==0)out("NO");
    else if(x==0 || y==0)out("YES");
    else if((x%y==0 || y%x==0))out("YES");
    else out("NO");
}
